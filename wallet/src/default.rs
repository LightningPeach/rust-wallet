...
//    }
    ...
    pub fn new(wc: WalletConfig, bio: Box<BlockChainIO + Send>, debug: bool) -> Result<WalletWithTrustedFullNode, WalletError> {
        let wallet_lib = Box::new(WalletLibrary::new(wc, debug).unwrap());
